    ...
    if($mode == "save")
	{
		...
		// 상품이미지
				...
				if(is_uploaded_file($tmpName0)){
						...
						$src = './product_img/'."$attc_name0[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name0[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName2)){
						...
						$src = './product_img/'."$attc_name2[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name2[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName3)){
						...
						$src = './product_img/'."$attc_name3[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name3[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName4)){
						...
						$src = './product_img/'."$attc_name4[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name4[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName5)){
						...
						$src = './product_img/'."$attc_name5[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name5[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName6)){
						...
						$src = './product_img/'."$attc_name6[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name6[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName7)){
						...
						$src = './product_img/'."$attc_name7[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name7[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName8)){
						...
						$src = './product_img/'."$attc_name8[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name8[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName9)){
						...
						$src = './product_img/'."$attc_name9[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name9[savedName]";     //-- 저장 
				...
				if(is_uploaded_file($tmpName10)){
						...
						$src = './product_img/'."$attc_name10[savedName]";        //-- 원본 
						$dst = './product_img/thum_'."$attc_name10[savedName]";     //-- 저장 
				...
				if($rst1)
				{
					echo "<meta http-equiv='refresh' content='0 url=./api_musical_regi.php?division=2&pdx=1&sub=45'>";
					exit;
				}
				else
				{
				...
				{
					@unlink("./product_img/$m_info[userfile0]");
					$attc_name0[savedName] = "";
				} 
				...
				{
					@unlink("./product_img/$m_info[userfile1]");
					$attc_name1[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile2]");
					$attc_name2[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile3]");
					$attc_name3[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile4]");
					$attc_name4[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile5]");
					$attc_name5[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile6]");
					$attc_name6[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile7]");
					$attc_name7[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile8]");
					$attc_name8[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile9]");
					$attc_name9[savedName] = "";
				}
				...
				{
					@unlink("./product_img/$m_info[userfile10]");
					$attc_name10[savedName] = "";
				}
				$m_name_eng = addslashes($m_name_eng);
				$m_name_kor = addslashes($m_name_kor);
		...
		<div class="main_content">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
				  <form action="<?= $PHP_SELF ?>?division=<?=$division?>&pdx=<?=$pdx?>&sub=<?=$sub?>" name=product method=post Enctype="multipart/form-data">
					...
					<table id="level4" class="txt_12" width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <script>
						...
						<tr bgcolor=#f9f9f9 height=28>
							...
							<option value="YES" <? if($m_info[view_opt] == "YES") echo "selected"; ?>>진열
							<option value="NO" <? if($m_info[view_opt] == "NO") echo "selected"; ?>>숨기기
							</select></td>
						</tr>
						...
						<tr bgcolor=#f9f9f9 height=28>
							...
							<option value="NYCA" <? if($m_info[m_city] == "NYCA") echo "selected"; ?>>NewYork
							<option value="LASV" <? if($m_info[m_city] == "LASV") echo "selected"; ?>>Las Vegas
							<option value="NYCA" <? if($m_info[m_city] == "NYCS") echo "selected"; ?>>NewYork Sports
							</select></td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
						...
						<tr bgcolor=#f9f9f9 height=28>
							...
							<option value="flat" <? if($m_info[sale_flag] == "flat") echo "selected"; ?>>$
							<option value="percent" <? if($m_info[sale_flag] == "percent") echo "selected"; ?>>%
						...
						<tr bgcolor=#f9f9f9 height=28>
							...
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile0]): ?><img src="./product_img/<?= $m_info[userfile0] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del0 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지 (banner)<br> 1920 X 344 pixel </td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile0 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (1)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile1]): ?><img src="./product_img/<?= $m_info[userfile1] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del1 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지 (1-메인)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile1 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (2)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile2]): ?><img src="./product_img/<?= $m_info[userfile2] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del2 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지 (2)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile2 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (3)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile3]): ?><img src="./product_img/<?= $m_info[userfile3] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del3 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지 (3)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile3 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (4)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile4]): ?><img src="./product_img/<?= $m_info[userfile4] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del4 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지 (4)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile4 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (5)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile5]): ?><img src="./product_img/<?= $m_info[userfile5] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del5 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(5)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile5 size=30 class="form_box"></td>
						</tr>
						
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (6)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile6]): ?><img src="./product_img/<?= $m_info[userfile6] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del6 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(6)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile6 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (7)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile7]): ?><img src="./product_img/<?= $m_info[userfile7] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del7 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(7)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile7 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (8)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile8]): ?><img src="./product_img/<?= $m_info[userfile8] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del8 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(8)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile8 size=30 class="form_box"></td>
						</tr>

						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (9)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile9]): ?><img src="./product_img/<?= $m_info[userfile9] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del9 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(9)<br> 800 X 344 pixel</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<input type=file name=userfile9 size=30 class="form_box"></td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>현재 이미지 (10)</td>
							<td bgcolor=#FFFFFF colspan=3>&nbsp;<? if($m_info[userfile10]): ?><img src="./product_img/<?= $m_info[userfile10] ?>" width=80 height=70><? endif; ?>&nbsp;<input type=checkbox name=photo_del10 value="1"> Delete Image file</td>
						</tr>
						<tr bgcolor=#f9f9f9 height=28>
							<td align=center>이미지(10)<br> 800 X 344 pixel</td>
