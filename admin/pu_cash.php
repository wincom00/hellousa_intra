				...
				<div class="col-sm-12 col-md-12">
					  <form action="<?= $PHP_SELF ?>?division=<?=$division?>&pdx=<?=$pdx?>&sub=<?=$sub?>" enctype="multipart/form-data" name="frmemp" id="frmemp" method="post" >
						...
						<table class="table table-striped table-bordered table-condensed">
						    <tbody>
									...
									<tr bgcolor=#f9f9f9 height=28>
										...
										<td width=35% align=left bgcolor=#FFFFFF>&nbsp;<input type="radio" name="sex" value = "M" <? if($v_info[sex] == "M") echo "checked"; ?>> 남 &nbsp;&nbsp;
										  <input type="radio" name="sex" value = "F" <? if($v_info[sex] == "F") echo "checked"; ?>> 여</td>
									</tr>
									...
									<tr bgcolor=#f9f9f9 height=28>
										...
										<td width=35% align=left bgcolor=#FFFFFF style="vertical-align : middle;">&nbsp;<? if($v_info[userfile1]): ?><IMG SRC="upload/<?= $v_info[userfile1] ?>" width=120><? endif; ?><input type=file name=userfile1 size=30 class='inpubase md' value="<?= $v_info[userfile1] ?>"></td>
									</tr>
									-->
						...
						<table class="table table-striped table-bordered table-condensed">
						    <tbody>
							        <tr>
										<td colspan=8 bgcolor=#F9F9F9 height=25>&nbsp;푸른머니적립/사용 추가</td>
									</tr>
									<tr bgcolor=#f9f9f9 height=28>
										...
										<td width=5% align=center>적립/시용내용</td>
										<td width=20% align=left bgcolor=#FFFFFF>&nbsp;<input type=text name=r_cont size=15 class='inpubase md' value=''></td>
										<td width=5% align=center>적립/사용금액</td>
										<td width=18% align=left bgcolor=#FFFFFF>&nbsp;<input type=text name=r_amt size=15 class='inpubase md' value=""></td>
									</tr>
									
									<tr>
										<td colspan=8 height=35 bgcolor=#FFFFFF align=center><input type=submit value="푸른머니 추가" class="btn btn-primary btn-sm addpa"> | <input type=button value="푸른머니 사용" class="btn btn-primary btn-sm usepa">
										</td>
									</tr>	
						...
						<table class="table table-striped table-bordered table-condensed">
						    <thead>
                                <tr>
									...
									<th scope="col" class="table_info text-center">적립/사용금액</th>
                            ...
                            <tbody id="loop_area1">
                                <?php
									...
									$rst1 = $dbConn->query($qry1);
									while($reserve = $rst1->fetch_assoc()){
