...
<?php 
    ...
    margin-bottom: 20px;'>
		...
		$table_content2 = "<table id='level4' style='width: 100%;line-height: inherit;text-align: left;border: 1px solid #aaa;font-size: 13px;border-collapse: collapse;
    border-spacing: 0;
    margin-bottom: 20px;'>
			<th>
