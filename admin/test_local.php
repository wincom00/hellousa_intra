 ...
 <?php  
		...
		while($zip_row1 = $zip_rst1->fetch_assoc()){
			...
			//echo $totalDay;
						...
						echo "<tr >
						<td align=left  style='border:0.05em solid #848484;' class='sticky-col first-col'bgcolor='$zip_row1[bgcolor]'><font style='font-size:8pt'>&nbsp;$zip_row1[p_code]<br/><b>&nbsp;$zip_row1[p_name]</b></font></td>
						$content
						</tr>";
