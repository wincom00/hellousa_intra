<?php
    ...
    FROM tour_guide a ,tour_car b WHERE a.seq_no = $seqno && a.grand_eCode=b.grand_eCode";
    ...
    // CAR SETTLE 정보
    $qry2 = "SELECT * FROM car_settle WHERE grand_eCode = '{$data_row['grand_eCode']}' AND sub_eCode = '{$data_row['sub_eCode']}' ";
    $rst2 = $dbConn->query($qry2);

    // CAR SETTLE ETC 정보
    $qry3 = "SELECT * FROM car_settleetc WHERE grand_eCode = '{$data_row['grand_eCode']}' AND sub_eCode = '{$data_row['sub_eCode']}' ";
    $rst3 = $dbConn->query($qry3);

    // CAR SETTLE SUM 정보
    $qry4 = "SELECT * FROM car_settlesum WHERE grand_eCode = '{$data_row['grand_eCode']}' AND sub_eCode = '{$data_row['sub_eCode']}' ";
                ...
                <table id="custom_table" class="table table-bordered table-condensed gridSixteen reserveTable formDetail">
                    <tbody>
                                ...
                                <div class="row hotel_div">
                                    <div class="col-sm-2">
                                        <select class="form-control hotellist" name="hotelSelect[]">
                                            ...
                                            <?php echo printCarSelect2($row1['c_code']); ?>
                                        </select>
                                    </div>    
                                    <div class="col-sm-3">
                        ...
                        <?php
                          ...
                          $qry00 = "SELECT * FROM tour_guide WHERE grand_eCode = '".$data_row['grand_eCode']."' AND sub_eCode = '".$data_row['sub_eCode']."' ORDER BY bus_num ASC";
                        ...
                        <tr class="basic-class" param="tr-parent">
                            <td colspan="2" class="active text-center formHeader">
                                차량선택&nbsp;<button type="button" class="btn btn-default btn-xs js-addPlusRow"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
                            </td>
                            ...
                            <td colspan="14">
                                <div class="row hotel_div">
                                    <div class="col-sm-2">
                                        <select class="form-control hotellist" name="hotelSelect[]">
                                            <option value="">- 차량을 선택하세요 -</option>
                                            <?php echo printCarSelect2($row00['c_id']); ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-addon">RATE</span>
                                            <input type="text" name="hotelRateRm[]" class="form-control rate" value=""/>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-addon">차량비</span>
                                            <input type="text" name="hotelCost[]" class="form-control hotelCost" value=""/>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 hide button-minus">
                                        <button type="button" class="btn btn-default btn-xs js-removeHotelButton"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button>
                            ...
                            <td colspan="14">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <select class="form-control hotellist" name="hotelSelect_etc[]">
                                            <option value="">- 차량을 선택하세요 -</option>
                                            <?php echo printCarSelect2($data_row['c_id']); ?>
                                        </select>
                                    </div>    
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="text-center" style="vertical-align:middle;">
                                <div class="btn-group btn-group-sm" role="group">
                                    <button type="button" class="btn btn-default" onclick="location.href='hotel_cal2.php?division=6&pdx=1&sub=10&number=<?=$seqno?>'">호텔 정산 등록</button>
