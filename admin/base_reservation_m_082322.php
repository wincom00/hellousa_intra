				...
				<table id="air" class="table table-bordered table-condensed gridSixteen">
					<tbody id="airtbody">
						...
						?>
											<tr class="airin2">
											  <td colspan='16'>
												  <table  class="table-bordered table-condensed gridSixteen">
													<tbody>
														 <tr >
