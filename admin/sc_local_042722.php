					...
					<div class="row">
						...
						<div class="col-sm-12 tableFixHead" >
						    <table width=100% id="guide_table" class="display nowrap table-bordered text-center">
                                <thead>
                                    <tr>
                                        <th  style ='border:0.05em solid #848484;width:17%' align=center>상&nbsp;품&nbsp;명</th>
                                        <?php
			...
			//echo $totalDay;
						...
						for($k=0; $k<$totalDay; $k++)
						{
							...
							$tmpstop_date  = date("Y-m-d",mktime (0,0,0,$tmpstart_date[1]  , $tmpstart_date[2]+$add_date, $tmpstart_date[0]));	
								...
								$r_adult = @dbMysql_result($r_rst1, 0, 0) + @dbMysql_result($r_rst1, 1, 0);
								...
								while($row1 = $rst1->fetch_assoc()){
							        ...
							        $hotel_qty1=$hotel_qty1+$row1[room_cnt];
			               ...
			               // echo $choose_date."|".$hotel_qty."|".$zip_row1[p_name]."<br>";	
							$content .= "<td height=35 style='width:10px;border:0.05em solid #848484;' align=center bgcolor=$bgcolor title='호텔 : ".$hotel_qty1."'>$block_content</font></td>";
							$hotel_qty1="";
						...
						echo "<tr >
						<td align=left  style='border:0.05em solid #848484;' bgcolor='$zip_row1[bgcolor]'><font style='font-size:8pt'>&nbsp;$zip_row1[p_code]<br/><b>&nbsp;$zip_row1[p_name]</b></font></td>
						$content
						</tr>";
