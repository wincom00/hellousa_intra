					  ...
					  <form action="<?= $PHP_SELF ?>?division=<?=$division?>&pdx=<?=$pdx?>&sub=<?=$sub?>" enctype="multipart/form-data" name="busfrm" id="busfrm" method="post">
						...
						<table class="table table-striped table-bordered table-condensed">
						    <tbody>
									...
									<tr bgcolor=#f9f9f9 height=28>
										<td width=15% align=center>차량아이디/닉네임</td>
										<td width=35% bgcolor=#FFFFFF>&nbsp;<input type=text name="bus_id"  id="bus_id" class="inpubase sm1" value="<?= $v_info[bus_id] ?>">&nbsp;<input type=text name="bus_sname"  id="bus_sname" class="inpubase sm1" value="<?= $v_info['bus_sname'] ?>"></td>
