<?php
	...
	function custlist() {
		     ...
		     $qry1="select b.reserveCode,b.pricet,b.p_code,b.air_arcity,b.air_arrivetime,b.air_arriveNm,b.meet_area,
			 ...
			 while($row1 = $rst1->fetch_assoc()){
				...
				$carinfo = getbusInfo2($s_code,$stdate,$row1['reserveCode']);
				...
				if ($reTrinfo[traveler_phone]!="") {
					$reTrinfo[traveler_phone]=$reTrinfo[traveler_phone];
				}
				
					echo "<tr>
							  <td rowspan='$row1[cnt]'><a href=javascript:openwin('$row1[reserveCode]','$row1[pricet]') >$row1[book_pri]</a></td>
							  <td ><a href=javascript:openwin('$row1[reserveCode]','$row1[pricet]') >$reTrinfo[traveler_nm]+$reInfo1<br />$reTrinfo[traveler_phone]</a></td>
							  
							  <td rowspan='$row1[cnt]'>$reInfo[room_cnt]</td>
							  
							  <td>$picnum</td>
							  <td>$rest</td>
							  <td >$reInfo[last_bal]</td>
...
<html>
    <head>
		...
		<!-- paran css -->
			<link rel="stylesheet" href="css/dongbu.css?sid=5fe18a1a-0023-476e-afb3-66cdb279d9f7" />
		<!-- favicon -->
