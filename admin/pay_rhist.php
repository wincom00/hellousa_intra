				...
				<div class="col-sm-12">
					...
					<table class="table table-bordered table-condensed gridSixteen paymentProcessingTable formDetail">
						<tbody>
							...
							<?php
										$qry1 = "select * from payment_history where reserveCode = '$r_code' && (payment_status ='RRQUEST' || payment_status ='RETURN')
										order by wdate asc";
							 ...
							 ?>
													<tr>
														...
														<td colspan="1" class="text-center">결제초기</td>
							 ...
							 <?php
												 ...
												 if ($p_row[payment_status] == "RETURN") {
													$mius ="<font color=red>- ".$signb.$p_row[payment]."</font>";
													$cappay = "환불";
													$mius1 ="<font color=red>- ".$signb.$p_row[rate_payment]."</font>";
													$cappay = "환불";
												 } else {
