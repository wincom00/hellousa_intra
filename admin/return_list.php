<?php
	...
	function printPay(){
			...
			$qry1 = "select 1 as gu,a.grand_revNo,a.reserveCode,a.p_code,a.p_name,a.book_pri,a.revDate,a.stDate,a.edDate,a.last_total,a.last_bal,a.p_cnt,a.base_rate,a.pricet,
			...
			a.last_total,a.last_bal,a.p_cnt,a.b_rate as base_rate,'' as pricet,
			b.payment_status,b.pay_method as pmethod,b.* ,DATE_FORMAT(b.wdate, '%Y-%m-%d')  as wwdate,b.register as pregister 
			...
			while($row1 = $rst1->fetch_assoc()){
				...
				echo "<tr>
						<td align='center'><a href=javascript:openwin('$row1[reserveCode]','$row1[p_code]')  >$row1[revDate]<br/>$row1[reserveCode]</a></td>
						<td align='center'>$row1[wwdate]</td>
						<td><a href=javascript:openwin('$row1[reserveCode]')  >$row1[p_name]</a></td>
						<td align='center'><a href=javascript:openwin1('$row1[reserveCode]','$row1[pricet]')  >$row1[book_pri]</a></td>
...
?>
    ...
    <script>
	    ...
	    function openwin(r_code,pcode) { 
		   ...
		   window.open("pay_rhist.php?r_code="+r_code+"&pcode="+pcode+"",winName,"width=1000,height=600,scrollbars=1");
	    }
