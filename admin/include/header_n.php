						...
						<div class="container-fluid">
							...
							<ul class="nav navbar-nav user_menu pull-right">
								<li class="hidden-phone hidden-tablet">
									...
									<a  href="sc_hotel.php" data-placement="bottom" target='_blank' data-container="body" class="label bs_ttip" title="호텔스캐쥴">호텔스캐쥴&nbsp;<i class="splashy-group_blue_edit"></i></a>
									<?php } ?>
