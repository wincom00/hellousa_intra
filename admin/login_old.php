<?php
	...
	//print_r($_COOKIE[MEMLOGIN_ADMIN_PURUN]);
...
<html lang="en" class="login_page">
    ...
    <body>
		...
		<div class="login_box">
			...
			<form action="<?= $PHP_SELF ?>" method="post" id="login_form">
			<input type=hidden name=mode value="save">
			<input type=hidden name=division value="admin">
				<div class="top_b">푸른투어 인트라넷 로그인</div>    
				...
				<div class="cnt_b">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input class="form-control input-sm" type="text" id="userid" name="userid" placeholder="사용자아이디" value="" />
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon input-sm"><i class="glyphicon glyphicon-lock"></i></span>
							<input class="form-control input-sm" type="password" id="passwd" name="passwd" placeholder="패스워드" value="" />
						</div>
					</div>
					<div class="form-group">
				...
				<div class="btm_b clearfix text-center">
					<button class="btn btn-default btn-sm" type="submit">로그인</button>
