<?php
	...
	function printemp() {
		...
		if ($startDate) {
			$query = "SELECT a.base_rate, SUM(a.p_cnt) cnt,SUM(last_total) totamt,COUNT(a.reserveCode) totcnt ,b.kor_name,b.c_part1 FROM reserve_info a ,member_list b ,product_master c WHERE a.userid=b.userid  && a.p_code= c.p_code && c.p_type in ('5')  && (a.rev_status ='DONE' ||a.rev_status ='ORDER') && a.parent='MAIN' 
		    $from_w $to_w $curqry GROUP BY a.userid order by b.c_part1";
			//echo $query;
	...
	function printemp1() {
		...
		if ($startDate) {
			$query = "SELECT a.base_rate, SUM(a.p_cnt) cnt,SUM(last_total) totamt,COUNT(a.reserveCode) totcnt ,b.kor_name,b.c_part1 FROM reserve_info a ,member_list b, product_master c WHERE a.userid=b.userid  && a.p_code= c.p_code && c.p_type =1 && (a.rev_status ='DONE' ||a.rev_status ='ORDER') && a.parent='MAIN'
		    $from_w $to_w $curqry GROUP BY a.userid order by b.c_part1";
		//echo $query;
			$rst1 = $dbConn->query($query);
			$k=1;$total_amt=0;$tot_pcnt=0;$totcnt=0;
...
?>
	<div id="contentwrapper" class="reservationDetailForm">
		<div class="main_content">
			...
			module">
				<ul>
					<li><a href="/admin">MIS<i class="glyphicon glyphicon-home"></i></a></li>
					<li><a href="#">자금현황</a></li>
					<li>직원별투어요약</li>
				</ul>
			</div>
