		...
		<div class="row">
				<div class="col-sm-12 col-md-12">
					   <table class="table table-striped table-bordered mediaTable" width="100%" >
						  <tr> 
							<td height="34" bgcolor="#eeeeee"><div align="center"> <strong><?= $title ?></strong> </div></td>
						  </tr>
						  <tr> 
							<td> <table class="table table-striped table-bordered mediaTable" width="100%"  cellspacing="1" bgcolor="E9E9E9">
								...
								<tr bgcolor="#FFFFFF"> 
								  ...
								  <td >&nbsp;&nbsp;<a href="download.php?filename=<?= $board_row2[userfile1] ?>"><img src='./img/database_save.png' align=absmiddle> <?= $board_row2[userfile1] ?></a></td>
								  <td align="center" bgcolor="#FBFBFB">첨부파일 2</td>
								  <td >&nbsp;&nbsp;<a href="download.php?filename=<?= $board_row2[userfile2] ?>"><img src='./img/database_save.png' align=absmiddle> <?= $board_row2[userfile2] ?></a></td>
								</tr>
								<tr bgcolor="#FFFFFF"> 
						  ...
						  <tr> 
							   ...
							   <td height="50" align="right"><table width="308" border="0" cellspacing="0" cellpadding="0">
								<tr align="right"> 
								  ...
								  * 답변은 이메일로 해주세요!
								  <?php } ?>
								  <?php if ($board_row2[userid] == $user_dbinfo[userid]): ?>
