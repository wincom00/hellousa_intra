...
<body style='max-width : 1280px;'>
	...
	<table style='width: 100%;line-height: inherit;text-align: left;border-top: 0px solid #fff;border-left: 0px solid #aaa;border-right: 0px solid #fff;'>
		...
		<div style="background:#196932;color:#ffffff;font-weight:bold;line-height:3.3;text-align: center;">예약을 확정합니다.</div>
		<br/>
					...
					<div class="row">
						<div width='100%' >
							...
							<span style="text-align: right;font-size:12px;">
								<img src="https://dongbutour.online/img/top_in.jpg" data-holder-rendered="true"  height="120px" width="100%"/>
							</span>
						</div>
