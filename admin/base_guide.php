	...
	function printVendor(){
			...
			//	echo $log_cnt[log_cnt]."11";
				if ($log_cnt[log_cnt] > 3 ) {
					 $st = '<td align=center bgcolor="ffcccc"><a href=base_guide.php?mode=update&division=$division&pdx=$pdx&sub=$sub&userid='.$usid.'>잠김</a></td>';
				} else {
...
<div id="contentwrapper">
    ...
    <script>
		function del(id){
			...
			{
				location.replace('base_guide.php?Mode=del&division=7&pdx=1&sub=15&id=' + id);
			}
			else return;
		}
