	...
	if($mode == "save")
	{
		...
		else
		{
				...
				for ( $i=1; $i <= $cnt; $i++ ) { 
						...
						$result_rows=mysqli_num_rows($rst1);
						if ($result_rows > 0) {
...
// $total = 0;
	...
	function printCoupon(){
		...
		$page_total = mysqli_num_rows($rst2);
			...
			<div id="jCrumbs" class="breadCrumb module">
			  ...
			  <script>
				...
				<tr bgcolor=#f9f9f9 height=28>
					...
					<td width=35% bgcolor=#FFFFFF colspan=3>&nbsp;<input type=text name=c_cnt id=c_cnt size=20 class="form_box" >
				...
				<tr bgcolor=#f9f9f9 height=28>
					<td width=15% align=center>쿠폰 금액</td>
			...
			<script>
			  ...
			  <table id="level4" class="table table-striped table-bordered table-condensed">
				<tr bgcolor=#f4f4f4 height=28>
					...
					<td width=10% align=center>쿠폰금액</td>
			  ...
			  <?php printCoupon(); ?>
			    ...
			    <tr>
				 <td colspan=10 align=center> <? board_pageNavigation(); ?> </td>
				</tr>
			  </table>
		</form>
	 </div>
