   ...
   //include "include/inc_base.php";
	...
	if ($mode == "save") {
		if ($gcode == "") {
			...
			$total_eventCode = "HSP".date("His", $sec) . $hs;
			$qry2 = "insert into tour_master 
			 ...
			 Misc::jvAlert("저장 완료!!!");
			 echo "<meta http-equiv='refresh' content='0; url=./eventbs_list.php?startDate1=$sdate&endDate1=$sdate&division=5&pdx=1&sub=10'>";
			 ...
			 $qry2 = " update tour_master 
			  ...
			  Misc::jvAlert("저장 완료!!!");
			  echo "<meta http-equiv='refresh' content='0; url=./eventbs_list.php?startDate1=$sdate&endDate1=$sdate&division=5&pdx=$pdx&sub=$sub'>";
		}
...
?>
	<div id="contentwrapper" class="reservationDetailForm">
		<div class="main_content">
			...
			<form  name="frmevent" id="frmevent" method="post" onSubmit="return chksave()">
				...
				<div class="row no-nav">
					<div class="col-sm-12 text-center">
						<button type="submit" class="btn btn-primary btn-sm js-esave" >행사저장</button>
					</div>
				</div>
				<br />
