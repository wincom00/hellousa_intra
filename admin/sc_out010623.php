...
<style>
 ...
 <?php  
        if (($user_dbinfo[dept_prior] == "J") || ($user_dbinfo[dept_prior] == "")) {
		    $deptqry = " && ((b.m_dept like '%$user_dbinfo[area_comp]%') || (b.m_dept=''))";
		} else {
		    $deptqry = "";
		}
		...
		while($zip_row1 = $zip_rst1->fetch_assoc()){
			...
			//echo $totalDay;
						...
						echo "<tr >
						<td align=left  style='border:0.05em solid #848484;' class='sticky-col first-col' bgcolor='$zip_row1[bgcolor]'><font style='font-size:8pt'>&nbsp;$zip_row1[p_code]&nbsp;<font color=red>($zip_row1[person])</font><br/><b>&nbsp;$zip_row1[p_name]</b></font></td>
						$content
						</tr>";
