<?php
      ...
      if($mode == 'delete_hotel'){
          ...
          $query = "SELECT bus_amt FROM car_settle WHERE seq_no = $d_seq ";
          $rst1 = mysqli_query($dbConn,$query);
          $data_row = mysqli_fetch_assoc($rst1);
          $hotelamt = $data_row[hotel_amt];

          $query="DELETE FROM car_settle WHERE seq_no = $d_seq";
