...
?>
					...
					<tbody>
					    <tr>
							...
							<td colspan="10" align=left bgcolor=#FFFFFF>
								&nbsp;<input type="radio" name="mty" value = "S" <? if($prodInfo[m_type] == "S") echo "checked"; ?>> 단일상품 &nbsp;&nbsp;
							  <input type="radio" name="mty" value = "D" <? if($prodInfo[m_type] == "D") echo "checked"; ?>> 복합상품
							</td>
						</tr>
						<!--<tr>
						...
						<tr>
							...
							<td colspan="10" class="form-inline">
								<select class="form-control fst1" name="area1" id="area1">
									<option value="">지역선택
									<?=printBaseCode_first('P01',$prodInfo[c_code1])?>
								</select>
								
								<select class="form-control fst2" name="area2" id="area2">
									<option value="">지역선택2</option>
									<?=printBaseCode_hsecond('P01',$lvcode2,$prodInfo[c_code2])?>
								</select>
						...
						<tr>
								...
								<td colspan="10">
									<table border=0>
										<tr>
										<?php
											$cr_qry1 = "select * from code_base where lvcode1 = 'P01' && lvcode2 <> '00' && lvcode3 <> '00' && lvcode4 <> '00' order by lvcode2 asc";
											$cr_rst1 = $dbConn->query($cr_qry1);
						...
						<?php
							...
							$d_rst1 = $dbConn->query($d_qry1);
							$d = 1;
							while($d_row1 = $d_rst1->fetch_assoc()):
						...
						<tr>
							...
							<td colspan="4">
								<select class="randcomp" name="p_own" id="p_own">
									...
									<option value="dongbu" selected>동부투어-본사</option>
						...
						<tr>
							...
							<td colspan="10">
							   <?php
									...
									$rst1 = $dbConn->query($qry1);
									$cnt = $rst1->num_rows;
									while($pick_row = $rst1->fetch_assoc()):
							...
							<td colspan="10">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="input-group thinMargin">
												<label for="displayAdultPrice0">표시용 성인</label>
										...
										<div class="col-sm-6">
											<div class="form-group thinMargin">
												<label for="displayChildPrice0">표시용 어린이</label>
												<div class="input-group thinMargin">
												<span class="input-group-addon"><?php if ($prodInfo[base_rate] == "CAD") echo "C$"; ?>
												<?php if ($prodInfo[base_rate] == "USD") echo "U$"; ?></span>
								...
								<div class="col-lg-3">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group thinMargin">
												<label for="partnerAdultPrice0">협력사 성인가</label>
										...
										<div class="col-sm-6">
											<div class="form-group thinMargin">
												<label for="partnerChildPrice0">협력사 어린이가</label>
									...
									<div class="row">
										<div class="col-sm-9">
											<div class="form-group thinMargin">
												...
												<input type="text" class="form-control" id="OutAdultPrice0" name="OutAdultPrice0" placeholder="아웃바운드기준가" value="<?=$prodInfo[oprice_0cadult]?>">
											</div>
										</div>
						...
						<tr>
							...
							<td colspan="10" class="form-inline">
							    <?php
									...
									$rst1 = $dbConn->query($qry1);
									$cntL = $rst1->num_rows;
									while($limit_row = $rst1->fetch_assoc()):
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 1(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 2(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 3(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 4(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 5(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 6(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 7(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 8(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 9(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">현재서브이미지 - 10(550X344)</td>
							<td colspan="4">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">상품개요</td>
							<td colspan="10">
						...
						<tr>
							<td colspan="2" class="active text-center formHeader">특전사항</td>
							<td colspan="10">
								<textarea class="form-control" name="pspecial" rows="10"><?= $prodInfo[p_spec] ?></textarea>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2" class="active text-center formHeader" >일반주의사항</td>
							<td colspan="10">
						...
						<tr>
							...
							<td colspan="3">
								<select name=grp class="form-control ">
									<option value="0" <? if ($prodInfo[grp]=='0') echo "selected"; ?>>그룹선택
									<option value="1" <? if ($prodInfo[grp]=='1') echo "selected"; ?>>그룹1
									<option value="2" <? if ($prodInfo[grp]=='2') echo "selected"; ?>>그룹2
									<option value="3" <? if ($prodInfo[grp]=='3') echo "selected"; ?>>그룹3
									<option value="4" <? if ($prodInfo[grp]=='4') echo "selected"; ?>>그룹4
									<option value="5" <? if ($prodInfo[grp]=='5') echo "selected"; ?>>그룹5
									<option value="6" <? if ($prodInfo[grp]=='6') echo "selected"; ?>>그룹6
									<option value="7" <? if ($prodInfo[grp]=='7') echo "selected"; ?>>그룹7
									<option value="8" <? if ($prodInfo[grp]=='8') echo "selected"; ?>>그룹8
									<option value="9" <? if ($prodInfo[grp]=='9') echo "selected"; ?>>그룹9
									<option value="10"<? if ($prodInfo[grp]=='10') echo "selected"; ?>>그룹10
									<option value="11"<? if ($prodInfo[grp]=='11') echo "selected"; ?>>그룹11
									<option value="12"<? if ($prodInfo[grp]=='12') echo "selected"; ?>>그룹12
									<option value="13"<? if ($prodInfo[grp]=='13') echo "selected"; ?>>그룹13
									<option value="14"<? if ($prodInfo[grp]=='14') echo "selected"; ?>>그룹14
									<option value="15"<? if ($prodInfo[grp]=='15') echo "selected"; ?>>그룹15
									<option value="16"<? if ($prodInfo[grp]=='16') echo "selected"; ?>>그룹16
									<option value="17"<? if ($prodInfo[grp]=='17') echo "selected"; ?>>그룹17
									<option value="18"<? if ($prodInfo[grp]=='18') echo "selected"; ?>>그룹18
									<option value="19"<? if ($prodInfo[grp]=='19') echo "selected"; ?>>그룹19
									<option value="20"<? if ($prodInfo[grp]=='20') echo "selected"; ?>>그룹20
									<option value="21"<? if ($prodInfo[grp]=='21') echo "selected"; ?>>그룹21
									<option value="22"<? if ($prodInfo[grp]=='22') echo "selected"; ?>>그룹22
									<option value="23"<? if ($prodInfo[grp]=='23') echo "selected"; ?>>그룹23
									<option value="24"<? if ($prodInfo[grp]=='24') echo "selected"; ?>>그룹24
									<option value="25"<? if ($prodInfo[grp]=='25') echo "selected"; ?>>그룹25
									<option value="26"<? if ($prodInfo[grp]=='26') echo "selected"; ?>>그룹26
									<option value="27"<? if ($prodInfo[grp]=='27') echo "selected"; ?>>그룹27
									<option value="28"<? if ($prodInfo[grp]=='28') echo "selected"; ?>>그룹28
									<option value="29"<? if ($prodInfo[grp]=='29') echo "selected"; ?>>그룹29
									<option value="30"<? if ($prodInfo[grp]=='30') echo "selected"; ?>>그룹30
									<option value="31"<? if ($prodInfo[grp]=='31') echo "selected"; ?>>그룹31
									<option value="32"<? if ($prodInfo[grp]=='32') echo "selected"; ?>>그룹32
									<option value="33"<? if ($prodInfo[grp]=='33') echo "selected"; ?>>그룹33
									<option value="34"<? if ($prodInfo[grp]=='34') echo "selected"; ?>>그룹34
									<option value="35"<? if ($prodInfo[grp]=='35') echo "selected"; ?>>그룹35
									<option value="36"<? if ($prodInfo[grp]=='36') echo "selected"; ?>>그룹36
									<option value="37"<? if ($prodInfo[grp]=='37') echo "selected"; ?>>그룹37
									<option value="38"<? if ($prodInfo[grp]=='38') echo "selected"; ?>>그룹38
									<option value="39"<? if ($prodInfo[grp]=='39') echo "selected"; ?>>그룹39
									<option value="40"<? if ($prodInfo[grp]=='40') echo "selected"; ?>>그룹40
									<option value="41"<? if ($prodInfo[grp]=='41') echo "selected"; ?>>그룹41
									<option value="42"<? if ($prodInfo[grp]=='42') echo "selected"; ?>>그룹42
									<option value="43"<? if ($prodInfo[grp]=='43') echo "selected"; ?>>그룹43
									<option value="44"<? if ($prodInfo[grp]=='44') echo "selected"; ?>>그룹44
									<option value="45"<? if ($prodInfo[grp]=='45') echo "selected"; ?>>그룹45
									<option value="46"<? if ($prodInfo[grp]=='46') echo "selected"; ?>>그룹46
									<option value="47"<? if ($prodInfo[grp]=='47') echo "selected"; ?>>그룹47
									<option value="48"<? if ($prodInfo[grp]=='48') echo "selected"; ?>>그룹48
									<option value="49"<? if ($prodInfo[grp]=='49') echo "selected"; ?>>그룹49
									<option value="50"<? if ($prodInfo[grp]=='50') echo "selected"; ?>>그룹50
								</select>
							</td>
						...
						<tr>
								...
								<td colspan="10">
									<input type="text" class="input md" id="bgcolor" name="bgcolor" placeholder="그룹배경색" value='<?=$prodInfo[bgcolor]?>'>&nbsp;&nbsp;<a href="https://htmlcolorcodes.com/" target="_blank">배경색(#00000)</a>
								</td>
						</tr>
							...
							<form action="<?= $PHP_SELF ?>?division=<?= $division ?>&pdx=<?= $pdx ?>&sub=<?= $sub ?>&ty=<?= $ty ?>&pcode=<?= $pcode ?>" name="frmproductschedule" id="frmproductschedule" method="post">
								...
								<div class="row">
									<div class="col-sm-6">
										<table class="table table-bordered table-condensed ptTable formSchedule scheduleHeader">
											<tbody>
												...
												<tr>
													<td colspan="2" class="active text-center formHeader">여행기간</td>
													<td colspan="10" class="js-formScheduleTourLength"><?=$prodInfo[p_day]?> 일&nbsp;<input type="text" class="form-control js-tourLength1" id="tourLength1" name="tourLength1" placeholder="여행기간" value="<?=$prodInfo[p_day]?>"></td>
												</tr>
											</tbody>
										</table>
									</div>
									<div class="col-sm-6 text-right">
										...
										<!--<button type="button" class="btn btn-xs btn-default js-scheduleADD">일정표추가</button>-->
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
										<table id="days" class="table table-bordered table-condensed ptTable formSchedule scheduleBody js-scheduleBody">
											...
											<tbody>	
												<?php
													...
													$d_rst2 = $dbConn->query($d_qry2);
													if ($dbConn->affected_rows > "0") {
													  $n =1;
													  while($d_row2 = $d_rst2->fetch_assoc()):
												?>
													
													    
														<tr id="days1" class="day-<?=$n?> ">
    ...
    <script>
			...
			/*var n = '<?=$n++; ?>';
			$(document).on('click', '.js-scheduleADD', function(){ 
				var $tableBody = $('#days').find("tbody:last"),
				
				$tBNew = $tableBody.clone().insertAfter('#days > tbody');

				//$tableBody.after('#days > tbody');
				//o++;
				
				$tBNew.find("td:eq(0)").find("font").text(n+"일차");
				alert(n);
				//$('#days > tbody').clone().insertAfter('#days > tbody');
